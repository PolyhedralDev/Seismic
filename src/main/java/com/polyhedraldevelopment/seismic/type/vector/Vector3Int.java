...
public class Vector3Int {
    ...
    public static class Mutable extends Vector3Int {
         ...
         */
        @NotNull
        public Vector3Int.Mutable rotateAroundY(Rotation rotation) {
         ...
         */
        @NotNull
        public Vector3Int.Mutable rotateAroundY(double angle) {
            double angleCos = TrigonometryFunctions.cos(angle);
            double angleSin = TrigonometryFunctions.sin(angle);
         ...
         */
        @NotNull
        public Vector3Int.Mutable rotateAroundZ(double angle) {
            double angleCos = TrigonometryFunctions.cos(angle);
            double angleSin = TrigonometryFunctions.sin(angle);
