...
public class CellularSampler extends CellularStyleSampler {
    ...
    public double getNoiseRaw(long sl, double x, double y, double z) {
        if(VMConstants.HAS_FAST_HUGE_METHODS) {
            return getNoiseRawUnrolled(sl, x, y, z);
        } else {
            return getNoiseRawLoop(sl, x, y, z);
        }
    }

    public double getNoiseRawLoop(long sl, double x, double y, double z) {
        int seed = (int) sl;
        int xr = FloatingPointFunctions.round(x);
        int yr = FloatingPointFunctions.round(y);
    ...
    //Manually unrolled
    public double getNoiseRawUnrolled(long sl, double x, double y, double z) {
        int seed = (int) sl;
        int xr = FloatingPointFunctions.round(x);
        int yr = FloatingPointFunctions.round(y);
        int zr = FloatingPointFunctions.round(z);
        ...
        int hash = HashingFunctions.hashPrimeCoords(seed, xrPrimed, yrPrimed, zrPrimed);
        int idx = hash & (255 << 2);

        double vecX = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx], threeDCellularJitter, xrMinusX);
        double vecY = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 1], threeDCellularJitter, yrMinusY);
        double vecZ = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 2], threeDCellularJitter, zrMinusZ);

        double newDistance = switch(distanceFunction) {
            case Euclidean, EuclideanSq -> ArithmeticFunctions.fma(vecX, vecX,
                ArithmeticFunctions.fma(vecY, vecY, vecZ * vecZ));
            case Manhattan -> Math.abs(vecX) + Math.abs(vecY) + Math.abs(vecZ);
            case Hybrid -> (Math.abs(vecX) + Math.abs(vecY) + Math.abs(vecZ)) +
                           ArithmeticFunctions.fma(vecX, vecX,
                               ArithmeticFunctions.fma(vecY, vecY, vecZ * vecZ));
        };
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPlus1Primed, yrPrimed, zrPrimed);
        idx = hash & (255 << 2);

        vecX = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx], threeDCellularJitter, xrPlus1MinusX);
        vecY = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 1], threeDCellularJitter, yrMinusY);
        vecZ = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 2], threeDCellularJitter, zrMinusZ);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrMinus1Primed, yrPrimed, zrPrimed);
        idx = hash & (255 << 2);

        vecX = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx], threeDCellularJitter, xrMinus1MinusX);
        vecY = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 1], threeDCellularJitter, yrMinusY);
        vecZ = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 2], threeDCellularJitter, zrMinusZ);
        ...
        if(newDistance < distance0) {
            if(needsDistance2) {
                if(needsDistance3) distance2 = distance1;
                distance1 = distance0;
            }
            distance0 = newDistance;

            if(needsClosestHash) closestHash = hash;
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPrimed, yrPlus1Primed, zrPrimed);
        idx = hash & (255 << 2);

        vecX = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx], threeDCellularJitter, xrMinusX);
        vecY = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 1], threeDCellularJitter, yrPlus1MinusY);
        vecZ = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 2], threeDCellularJitter, zrMinusZ);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPrimed, yrMinus1Primed, zrPrimed);
        idx = hash & (255 << 2);

        vecX = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx], threeDCellularJitter, xrMinusX);
        vecY = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 1], threeDCellularJitter, yrMinus1MinusY);
        vecZ = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 2], threeDCellularJitter, zrMinusZ);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPrimed, yrPrimed, zrPlus1Primed);
        idx = hash & (255 << 2);

        vecX = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx], threeDCellularJitter, xrMinusX);
        vecY = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 1], threeDCellularJitter, yrMinusY);
        vecZ = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 2], threeDCellularJitter, zrPlus1MinusZ);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPrimed, yrPrimed, zrMinus1Primed);
        idx = hash & (255 << 2);

        vecX = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx], threeDCellularJitter, xrMinusX);
        vecY = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 1], threeDCellularJitter, yrMinusY);
        vecZ = ArithmeticFunctions.fma(CellularSampler.RAND_VECS_3D[idx | 2], threeDCellularJitter, zrMinus1MinusZ);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPlus1Primed, yrPlus1Primed, zrPrimed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPlus1Primed, yrMinus1Primed, zrPrimed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrMinus1Primed, yrPlus1Primed, zrPrimed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrMinus1Primed, yrMinus1Primed, zrPrimed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPlus1Primed, yrPrimed, zrPlus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPlus1Primed, yrPrimed, zrMinus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrMinus1Primed, yrPrimed, zrPlus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrMinus1Primed, yrPrimed, zrMinus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPrimed, yrPlus1Primed, zrPlus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPrimed, yrPlus1Primed, zrMinus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPrimed, yrMinus1Primed, zrPlus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPrimed, yrMinus1Primed, zrMinus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPlus1Primed, yrPlus1Primed, zrPlus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPlus1Primed, yrPlus1Primed, zrMinus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPlus1Primed, yrMinus1Primed, zrPlus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrPlus1Primed, yrMinus1Primed, zrMinus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrMinus1Primed, yrPlus1Primed, zrPlus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrMinus1Primed, yrPlus1Primed, zrMinus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrMinus1Primed, yrMinus1Primed, zrPlus1Primed);
        idx = hash & (255 << 2);
        ...
        hash = HashingFunctions.hashPrimeCoords(seed, xrMinus1Primed, yrMinus1Primed, zrMinus1Primed);
        idx = hash & (255 << 2);
        ...
        return returnType.getReturn(this, sl, distance0, distance1, distance2, x, y, z, centerX, centerY,
            centerZ, closestHash);
    }
}
