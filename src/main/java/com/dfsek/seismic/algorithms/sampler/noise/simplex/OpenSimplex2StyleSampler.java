...
public abstract class OpenSimplex2StyleSampler extends SimplexStyleSampler {
    ...
    protected static final double ONE_MINUS_DOUBLE_UNSKEW_2D = 1 - DOUBLE_UNSKEW_2D;
    protected static final double GRADIENT_SCALE_PRIMARY = (2 * ONE_MINUS_DOUBLE_UNSKEW_2D * (1 / OpenSimplex2StyleSampler.UNSKEW_2D - 2));
    protected static final double GRADIENT_SCALE_SECONDARY = (-2 * ONE_MINUS_DOUBLE_UNSKEW_2D * ONE_MINUS_DOUBLE_UNSKEW_2D);
