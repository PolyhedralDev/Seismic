...
public class ValueCubicSampler extends ValueStyleNoise {
    ...
    public double getNoiseRaw(long sl, double x, double y) {
        ...
        x1 *= Sampler.PRIME_X;
        y1 *= Sampler.PRIME_Y;
        int x0 = x1 - Sampler.PRIME_X;
        int y0 = y1 - Sampler.PRIME_Y;
        int x2 = x1 + Sampler.PRIME_X;
        int y2 = y1 + Sampler.PRIME_Y;
        int x3 = x1 + (Sampler.PRIME_X << 1);
        int y3 = y1 + (Sampler.PRIME_Y << 1);
    ...
    public double getNoiseRaw(long sl, double x, double y, double z) {
        ...
        int x0 = x1 - Sampler.PRIME_X;
        int y0 = y1 - Sampler.PRIME_Y;
        int z0 = z1 - Sampler.PRIME_Z;
        int x2 = x1 + Sampler.PRIME_X;
        int y2 = y1 + Sampler.PRIME_Y;
        int z2 = z1 + Sampler.PRIME_Z;
        int x3 = x1 + (Sampler.PRIME_X << 1);
        int y3 = y1 + (Sampler.PRIME_Y << 1);
        int z3 = z1 + (Sampler.PRIME_Z << 1);
