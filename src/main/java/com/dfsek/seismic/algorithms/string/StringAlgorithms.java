...
public class StringAlgorithms {
     ...
     *   <li>If an uppercase letter is preceded by an uppercase letter and followed by a lowercase letter, an underscore is inserted before the uppercase letter.</li>
