...
import  com.dfsek.seismic.algorithms.samplers.noise.simplex.OpenSimplex2Sampler;
...
public class CellularSampler extends NoiseFunction {
    ...
    public double getNoiseRaw(long sl, double x, double y) {
        ...
        return switch (returnType) {
            ...
            case NoiseLookup -> noiseLookup.getNoise(sl - (saltLookup ? 0 : salt), centerX, centerY);
            case LocalNoiseLookup ->
                    noiseLookup.getNoise(sl - (saltLookup ? 0 : salt), x / frequency - centerX, y / frequency - centerY);
    ...
    public double getNoiseRaw(long sl, double x, double y, double z) {
        ...
        return switch (returnType) {
            ...
            case Distance2Mul -> distance1 * distance0 * 0.5 - 1;
            case Distance2Div -> distance0 / distance1 - 1;
            case NoiseLookup -> noiseLookup.getNoise(sl - (saltLookup ? 0 : salt), centerX, centerY, centerZ);
            case LocalNoiseLookup ->
                    noiseLookup.getNoise(sl - (saltLookup ? 0 : salt), x / frequency - centerX, y / frequency - centerY, z / frequency - centerZ);
            case Distance3 -> distance2 - 1;
            case Distance3Add -> (distance2 + distance0) * 0.5 - 1;
            case Distance3Sub -> distance2 - distance0 - 1;
            case Distance3Mul -> distance2 * distance0 - 1;
