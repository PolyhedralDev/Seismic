...
import static com.dfsek.seismic.util.MathHelper.*;

/**
 * NoiseSampler implementation to provide Perlin Noise.
 *
 * <p>
 * Perlin noise should generally should not be used;
 * use {@link OpenSimplex2Sampler} instead.
 *
 * @author FastNoiseLite contributors
 * @see OpenSimplex2Sampler
 */
public class PerlinSampler extends SimplexFunction {
