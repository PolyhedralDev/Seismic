package com.dfsek.seismic.function.simplex;

import static com.dfsek.seismic.util.MathHelper.fastFloor;

/**
 * NoiseFunction implementation to provide Simplex noise.
 * <p>
 * Generally should not be used; use {@link OpenSimplex2Sampler} instead.
 *
 * @author FastNoiseLite contributors
 * @see OpenSimplex2Sampler
 */
public class SimplexSampler extends SimplexFunction {
