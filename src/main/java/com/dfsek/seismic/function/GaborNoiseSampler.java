...
import com.dfsek.seismic.function.random.WhiteNoiseSampler;
...
public class GaborNoiseSampler extends NoiseFunction {
    ...
    private double kernelRadius = (fastSqrt(-FastMath.log(0.05) / Math.PI) / a);
    ...
    private void recalculateRadiusAndDensity() {
        kernelRadius = (fastSqrt(-FastMath.log(0.05) / Math.PI) / this.a);
